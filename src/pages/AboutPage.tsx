  ...
  return (
    <div className="min-h-screen bg-brand-50 text-brand-950">
      <main
        ...
        id="main-content"
      >
        <section className="space-y-12 rounded-4xl bg-brand-100/15 p-6 sm:p-10 lg:p-12">
          ...
          <section className="space-y-8">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                {
                  title: "Simplicity",
                  desc: "Recipes anyone can make — even on busy days.",
                },
                {
                  title: "Nutrition",
                  desc: "Every recipe supports your child’s growth.",
                },
                {
                  title: "Joy",
                  desc: "Food should be fun, colorful, and full of love.",
                },
                {
                  title: "Trust",
                  desc: "Honest guidance and real ingredients — always.",
                },
              ].map((value, index) => (
                <article
                  key={index}
          ...
          <section className="rounded-3xl border border-brand-200 bg-linear-to-b from-white to-brand-50 p-8 shadow-lg">
            ...
            <ul className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                <li
                  key={i}
                  className="flex items-center text-sm text-brand-700"
                >
