...
export const Footer = () => (
  <footer className="bg-brand-950 text-brand-400 px-8 lg:px-12 py-16">
    <div className="max-w-7xl mx-auto">
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-12 gap-10">
        <div>
          <div className="text-3xl font-black text-white tracking-tighter mb-3">
            <Logo />
          </div>
